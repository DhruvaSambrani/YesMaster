...
# !!! Main.UserApp is configured as an alias for Main.YesMaster and you might encounter it in some tests
using Main.YesMaster, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "YesMaster tests" begin
  @includetests ARGS
end
